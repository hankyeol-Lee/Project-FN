...
public class miniMap_UI_Touch : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    {
        delta_MiniMap_POS = new Vector2(miniMap_CamUI_Move.miniMap_CamUI_POS.position.x - MiniMap_UI_RT.position.x, miniMap_CamUI_Move.miniMap_CamUI_POS.position.y - MiniMap_UI_RT.position.y);
        Current_MiniMap_Touch_POS = new Vector3(eventData.position.x, eventData.position.y, -6);
    }
